  ...
  return (
    <div className="App" data-theme='light'>
      <div className="header">
        <h1 style={{ fontSize: "5rem", fontWeight: 'bold' }}>Lauren Kemperman</h1>
